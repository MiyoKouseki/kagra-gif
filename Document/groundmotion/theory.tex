...
%% このとき発散成分である$\bm{u}_{\mathrm{div}}$は$\nabla\times\bm{u}_{\mathrm{div}}=0$なので、回転成分を持たず、進行方向に対して平行に振動することから、縦波と呼ばれる。
%% 一方で回転成分である$\bm{u}_{\mathrm{rot}}$は$\nabla\cdot\bm{u}_{\mathrm{rot}}=0$なので
%% 、発散成分を持たず、進行方向に対して垂直に振動することから、横波と呼ばれる。
