...
f,mag = np.loadtxt('./TFs_190821/IPL2TML.mag',unpack=True)
f,deg = np.loadtxt('./TFs_190821/IPL2TML.deg',unpack=True)
f,coh = np.loadtxt('./TFs_190821/IPL2TML.coh',unpack=True)
