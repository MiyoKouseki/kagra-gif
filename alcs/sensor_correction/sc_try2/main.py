...
def timeseries(start,end,plot=True):
    ...
    if plot:
        ...
        plt.close()
    return gif,xarm,diff_seis,comm_seis,diff_acc_l
...
def asd(gif,xarm,diff_seis,comm_seis,diff_acc,fftlen=2**8,ovlp=2**7):
    ...
    diff_acc = diff_acc/w
    return gif,xarm,diff_seis,comm_seis,diff_acc


# simulation

# Timeseries
gif,xarm,diff_seis,comm_seis,diff_acc = timeseries(start,end)
...
# ASD
gif,xarm,diff_seis,comm_seis,diff_acc = asd(gif,xarm,diff_seis,comm_seis,diff_acc,
