...
plt.subplots_adjust(hspace=0.06)
#ax1.set_title(hoge,fontsize=40)
ax1.loglog(xarm,label='X-Arm',color='k',linewidth=2)
#ax1.loglog(xarm.rms(),color='b',linewidth=2,linestyle='--')
ax1.loglog(gif,label='GIF strainmeter',color='k',linestyle="--")
#ax1.loglog(comm_seis,label='Seismometer comm.',color='r',linestyle='-',linewidth=1)
ax1.loglog(diff_seis,label='Seismometer diff.',color='k',linestyle=':',linewidth=1)
#ax1.loglog(diff_seis.rms(),color='k',linestyle='--',linewidth=2)
...
ax1.legend(loc='upper center', bbox_to_anchor=(1.45, 0.8), shadow=True, ncol=1,fontsize=20)
#ax1.legend(fontsize=20,loc='lower left')
ax1.set_ylim(1e-4,10)
...
ax2.legend(loc='upper center', bbox_to_anchor=(1.45, 0.8), shadow=True, ncol=1,fontsize=20)
