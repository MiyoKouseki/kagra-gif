...
ax1.legend(loc='upper center', bbox_to_anchor=(1.45, 0.8), shadow=True, ncol=1,fontsize=18)
#ax1.legend(fontsize=20,loc='lower left')
ax1.set_ylim(1e-4,10)
...
ax2.legend(loc='upper center', bbox_to_anchor=(1.45, 0.8), shadow=True, ncol=1,fontsize=18)
