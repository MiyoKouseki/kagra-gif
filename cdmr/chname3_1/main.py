...
def read_gif(chname,start,end,write=False):    
    ...
    strain.name = chname
    if write:
        strain.write('./chname3_1_tr240ew.gwf',format='gwf.lalframe')
...
median_x1500 = read('./chname3_1_X_x1500_50pct.hdf5')
median_strain = read('./chname3_1_X_strain_50pct.hdf5')
...
plot.savefig('ASD_chname3_1_X.png')
