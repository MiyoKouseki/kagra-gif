...
chname = ['K1:PEM-IXV_GND_TR120Q_X_IN1_DQ',
          'K1:PEM-IXV_GND_TR120QTEST_X_IN1_DQ',
          'K1:PEM-EXV_GND_TR120Q_X_IN1_DQ',]
data = TimeSeriesDict.read('../m31/chname3_2_X.gwf',chname,
                           format='gwf.lalframe',
                           start=start,
                           end=end,
                           pad=np.nan,
...
if True:
    ...
    save(median_0, fname='./chname3_2_X_exv_50pct.hdf5')
    save(low_0, fname='./chname3_2_X_exv_5pct.hdf5')
    save(high_0, fname='./chname3_2_X_exv_95pct.hdf5')
    median_1.name = 'ixv1_x_50pct'
    low_1.name = 'ixv1_x_5pct'
    high_1.name = 'ixv1_x_95pct'    
    save(median_1, fname='./chname3_2_X_ixv1_50pct.hdf5')
    save(low_1, fname='./chname3_2_X_ixv1_5pct.hdf5')
    save(high_1, fname='./chname3_2_X_ixv1_95pct.hdf5')
    median_2.name = 'ixv2_x_50pct'
    low_2.name = 'ixv2_x_5pct'
    high_2.name = 'ixv2_x_95pct'        
    save(median_2, fname='./chname3_2_X_ixv2_50pct.hdf5')
    save(low_2, fname='./chname3_2_X_ixv2_5pct.hdf5')
    save(high_2, fname='./chname3_2_X_ixv2_95pct.hdf5')
    median_d12.name = 'diff12_x_50pct'
    low_d12.name = 'diff12_x_5pct'
    high_d12.name = 'diff12_x_95pct'        
    save(median_d12, fname='./chname3_2_X_diff12_50pct.hdf5')
    save(low_d12, fname='./chname3_2_X_diff12_5pct.hdf5')
    save(high_d12, fname='./chname3_2_X_diff12_95pct.hdf5')
    median_c12.name = 'comm12_x_50pct'
    low_c12.name = 'comm12_x_5pct'
    high_c12.name = 'comm12_x_95pct'        
    save(median_c12, fname='./chname3_2_X_comm12_50pct.hdf5')
    save(low_c12, fname='./chname3_2_X_comm12_5pct.hdf5')
    save(high_c12, fname='./chname3_2_X_comm12_95pct.hdf5')
