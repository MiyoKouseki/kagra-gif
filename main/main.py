...
class seismometer():
    ...
    def set_input(self):
        ...
        'K1:PEM-EX1_SEIS_NS_SENSINF_OUT16',
        'K1:PEM-EX1_SEIS_Z_SENSINF_OUT16',
        'K1:PEM-EY1_SEIS_WE_SENSINF_OUT16',
        'K1:PEM-EY1_SEIS_NS_SENSINF_OUT16',
        ...
        self.data = reader.kagra(self.start,self.tlen,['K1:PEM-EX1_SEIS_WE_SENSINF_OUT16','K1:PEM-EX1_SEIS_NS_SENSINF_OUT16','K1:PEM-EX1_SEIS_Z_SENSINF_OUT16'])
...
if __name__ == '__main__':
    start,tlen = main_getGPStime()
    #   
    a = seismometer(start,tlen)
