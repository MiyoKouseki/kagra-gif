...
if True:    
    ...
    start = tconvert('Nov 29 2018 00:00:10 JST') # stable
    end = tconvert('Nov 29 2018 09:00:00 JST')
    ...
    # no5_temp = no5_temp.decompose()
    # no5_humd = no5_humd.decompose()
    # no5_baro = no5_baro.decompose()
    # no6_temp = no6_temp.decompose()
    # no6_humd = no6_humd.decompose()
    # no6_baro = no6_baro.decompose()    
...
if False:    
    ...
    end = tconvert('Nov 27 2018 12:15:00 JST') #
    ...
    chlst = [
        ...
        'K1:PEM-IY0_SENSOR9_OUT16', # Cannnt read old channel using nds !! Use gwf!
