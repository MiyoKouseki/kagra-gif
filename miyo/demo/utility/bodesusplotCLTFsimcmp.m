%% main
function bodesusplotSUMCONsimcmp(sys,inv,outv,freq,data,varargin)
...
if ~fg_l; legendarg={'Control ON','Control OFF'}; end;
...
fig=figure;
subplot(5,1,[1 2 3])
loglog(freq,mag,colorarg{1},data(:,1),data(:,2),colorarg{3},'LineWidth',2,'MarkerSize',2)
grid on
