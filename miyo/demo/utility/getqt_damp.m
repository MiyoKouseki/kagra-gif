%%main
function getqt_damp(sysc0,sysc)
...
vecpolec=vecpolec(real(vecpolec)<0);
vecpolec=vecpolec(imag(vecpolec)>1e-10);
...
grid on
title('Quality factor with damping controls ON and OFF','FontSize',12,'FontWeight','bold','FontName','Times New Roman',...
    'interpreter','none')
