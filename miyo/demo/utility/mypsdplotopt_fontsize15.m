function mypsdplotopt_fontsize15(val,freq,varargin)
...
grid on
title(titlearg,'FontSize',15,'FontWeight','bold','FontName','Times New Roman')
ylabel(ylabelarg,'FontSize',15,'FontWeight','bold','FontName','Times New Roman')
if fg_y
    ylim(ylimarg);
end
...
xlabel('Frequency [Hz]','FontSize',15,'FontWeight','bold','FontName','Times New Roman')
