...
def huge(axis,**kwargs):
    ...
    return h01,h10,h50,h90,h99
    
def hoge(plot_v=False,plot_99=False,unit='um',peterson=True,plot_selfnoise=True,plot_rms=False,plot_h=False,fname_suffix='',day=False,night=False,**kwargs):
    #
    kwargs['unit'] = unit
    kwargs['suffix'] = '1211817600_1245372032'
    h01,h10,h50,h90,h99 = huge('H',_dir='LongTerm_gauss',**kwargs)
    z01,z10,z50,z90,z99 = huge('Z',_dir='LongTerm_gauss',**kwargs)
    h01_n,h10_n,h50_n,h90_n,h99_n = huge('H',_dir='LongTerm_gauss_night',**kwargs)
    z01_n,z10_n,z50_n,z90_n,z99_n = huge('Z',_dir='LongTerm_gauss_night',**kwargs)
    h01_d,h10_d,h50_d,h90_d,h99_d = huge('H',_dir='LongTerm_gauss_day',**kwargs)
    z01_d,z10_d,z50_d,z90_d,z99_d = huge('Z',_dir='LongTerm_gauss_day',**kwargs)        
    #
